...
if __name__ == "__main__":
    policy = Policy("Access Control Policy" , "Define and enforce access permissions based on roles.")
    #policy.insertPolicy()

    #policy = Policy("Password Policy" , "Enforce strong passwords with minimum length and complexity.")
    policy.updatePolicy("Access Control Policy" , "New description 123456")
    ...
    '''
    cursor.execute("""
        CREATE TABLE policies(id INT , name text , description text , version INT)
    """)
